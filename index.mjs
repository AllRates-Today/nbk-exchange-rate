// National Bank of Kazakhstan exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/nbk';
...
/** Latest rate for one pair, e.g. getRate('USD', 'KZT', { apiKey }). */
