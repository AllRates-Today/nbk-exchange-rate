# National Bank of Kazakhstan Exchange Rate API — nbk-exchange-rate
...
Also published under the org scope as [`@allratestoday/nbk-exchange-rate`](https://www.npmjs.com/package/@allratestoday/nbk-exchange-rate) — same code, same versions.
...
```javascript
{
  ...
  rate_date: '2026-09-09',   // National Bank of Kazakhstan's own publication date
  source: 'USD',
  target: 'KZT',
  rate: 454.46,
  rate_type: 'reference',
...
```javascript
{
  ...
  rates: [
    { "base": "USD", "quote": "KZT", "type": "reference", "value": 454.46 },
...
const series = await getHistory(
  { source: 'USD', target: 'KZT', from: '2026-01-01', to: '2026-09-09' },
  { apiKey: 'art_live_...' }
);
```
...
```javascript
{
  ...
  rates: [
    ...
    { date: '2026-09-09', rate: 454.46, rate_type: 'reference', derived: false, method: 'published' },
    // …
  ],
  disclaimer: '…'
}
